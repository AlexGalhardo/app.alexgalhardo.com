const card = /** *** */ (function (modules) {
    ...
    /** *** */ [
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            const update = __webpack_require__(5)(content, {});
            ...
            if (false) {
                ...
                if (!content.locals) {
                    module.hot.accept(
                        ...
                        function () {
                            let newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/index.js!./card.scss");
        ...
        /***/ function (module, exports, __webpack_require__) {
            /* WEBPACK VAR INJECTION */ (function (global) {
                ...
                (function () {
                    ...
                    let cards;
                    let defaultFormat;
                    let formatBackCardNumber;
                    let formatBackExpiry;
                    let formatCardNumber;
                    let formatExpiry;
                    let formatForwardExpiry;
                    let formatForwardSlash;
                    let formatMonthExpiry;
                    let hasTextSelected;
                    let luhnCheck;
                    let reFormatCardNumber;
                    let restrictCVC;
                    let restrictCardNumber;
                    let restrictCombinedExpiry;
                    let restrictExpiry;
                    let restrictMonthExpiry;
                    let restrictNumeric;
                    let restrictYearExpiry;
                    let setCardType;
                    const indexOf =
                        [].indexOf ||
                        function (item) {
