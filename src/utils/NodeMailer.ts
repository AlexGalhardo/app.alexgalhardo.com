...
export default class NodeMailer {
	...
	static async sendShopTransaction({ transaction_id, card_id, paid, products, products_amount, shipping_fee, total_amount, shipping_address_zipcode, shipping_address_street, shipping_address_neighborhood, shipping_address_city, shipping_address_state }: ShopTransactionDTO) {
	...
	static async sendSubscriptionTransaction({ transaction_id, status, plan_name, plan_amount, card_id, card_brand, card_exp_month, card_exp_year, card_last4, current_period_start, current_period_end }: SubscriptionTransactionDTO) {
