...
export default class StripeRepository {
	static async createShopTransaction(shopTransactionObject: ShopTransactionDTO) {
	...
	static async createSubscriptionTransaction(subscriptionTransactionObject: SubscriptionTransactionDTO) {
