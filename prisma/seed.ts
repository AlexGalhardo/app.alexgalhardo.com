    ...
    await prisma.game.createMany({
        data: [
            ...
            },
            {
                ...
                igdb_link:
                    'https://www.igdb.com/games/uncharted-the-lost-legacy',
                igdb_rating: 92,
                platforms: 'PS4, PS5',
                developer: 'Naughty Dog',
            ...
            },
            {
                ...
                igdb_link:
                    'https://www.igdb.com/games/uncharted-the-nathan-drake-collection',
                igdb_rating: 90,
                platforms: 'PS4',
                developer: 'Naughty Dog',
                genres: 'Single Player, Adventure, Action, Shooter, Third Person',
    ...
    await prisma.book.createMany({
        data: [
            ...
            },
            {
                ...
                amazon_link:
                    'https://www.amazon.com/gp/product/B004W2UBYW/ref=dbs_a_def_rwt_bibl_vppi_i1',
            ...
            },
            {
                ...
                amazon_link:
                    'https://www.amazon.com/gp/product/B071Y385Q1/ref=dbs_a_def_rwt_bibl_vppi_i2',
            ...
            },
            {
                ...
                amazon_link:
                    'https://www.amazon.com/gp/product/B000FBJG4U/ref=dbs_a_def_rwt_bibl_vppi_i4',
    ...
    await prisma.movie.createMany({
        data: [
            ...
            },
            {
                ...
                tmdb_link:
                    'https://www.themoviedb.org/movie/634649-spider-man-no-way-home?language=en-US',
                tmdb_rating: 95,
                justwatch_link: null,
            ...
            },
            {
                ...
                tmdb_link:
                    'https://www.themoviedb.org/movie/568124-encanto?language=en-US',
                tmdb_rating: 82,
                justwatch_link: null,
            ...
            },
            {
                ...
                tmdb_link:
                    'https://www.themoviedb.org/movie/624860-the-matrix-resurrections?language=en-US',
                tmdb_rating: 75,
                justwatch_link: null,
            ...
            },
            {
                ...
                tmdb_link:
                    'https://www.themoviedb.org/movie/617653-the-last-duel?language=en-US',
                tmdb_rating: 81,
                justwatch_link: null,
            ...
            },
            {
                ...
                tmdb_link:
                    'https://www.themoviedb.org/movie/635302?language=en-US',
                tmdb_rating: 84,
                justwatch_link: null,
        ...
        data: [
            {
                ...
                tmdb_link:
                    'https://www.themoviedb.org/tv/71912-the-witcher?language=en-US',
                tmdb_rating: 87,
                justwatch_link: null,
            ...
            },
            {
                ...
                tmdb_link:
                    'https://www.themoviedb.org/tv/71914-the-wheel-of-time?language=en-US',
                tmdb_rating: 83,
                justwatch_link: null,
            ...
            },
            {
                ...
                tmdb_link:
                    'https://www.themoviedb.org/tv/71446-la-casa-de-papel?language=en-US',
                tmdb_rating: 95,
                justwatch_link: null,
            ...
            },
            {
                ...
                tmdb_link:
                    'https://www.themoviedb.org/tv/94605-arcane?language=en-US',
                tmdb_rating: 92,
                justwatch_link: null,
            ...
            },
            {
                ...
                tmdb_link:
                    'https://www.themoviedb.org/tv/60625-rick-and-morty?language=en-US',
                tmdb_rating: 88,
                justwatch_link: null,
