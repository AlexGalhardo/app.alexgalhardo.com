...
- <b>The goal is to be refactoring it over the years during my professional career as I develop my programming/technical skills.</b>
## APP FEATURES
...
- Simple Subscriptions (Like a software as a service)
- Blog
